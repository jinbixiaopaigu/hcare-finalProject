...
@PreAuthorize(HasPerm('medical:cbt:sync'))
@Log(title='连续体温', business_type=BusinessType.UPDATE)
def sync_continuous_body_temperature():
    ...
    try:
        ...
        # 同步连续体温表
        inserted, updated = synchronizer.synchronize_table('continuous_body_temperature')
